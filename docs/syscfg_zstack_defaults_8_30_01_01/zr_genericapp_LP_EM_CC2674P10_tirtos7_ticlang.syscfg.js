...
AESCCM.aesccmImplementation = "AESCCMCC26X4"; // type: string
...
device.xoscCapArrayDelta = 213; // type: number
...
device.markAllFlashSecure = true; // type: boolean
...
RF.pinSelectionAntenna = 2; // type: number
...
zstack.rf.rfDesign = "LP_EM_CC2674P10"; // type: string
...
zstack.rf.radioConfig.txPowerHi = "20"; // type: string
zstack.rf.radioConfig.highPA = true; // type: boolean
...
NVS1.internalFlash.regionBase = 1038336; // type: number
NVS1.internalFlash.regionSize = 10240; // type: number
NVS1.internalFlash.sectorSize = 2048; // type: number
